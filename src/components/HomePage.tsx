...
import { FileText, Brain, Wifi, WifiOff } from 'lucide-react';
...
export function HomePage() {
  ...
  const { setCurrentDocumentId, setCurrentGraphData, isOnline, setIsOnline, modeSelected, setModeSelected } = useApp();
  ...
  const handleOnlineModeSelect = (online: boolean) => {
    setIsOnline(online);
    setModeSelected(true);
    setError(null);
  };

  const handleBackToModeTypeSelection = () => {
            ...
            {!modeSelected ? (
                  ...
                  <div className="p-6 text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-keystone-text-muted">
                        Use cloud-based AI services for processing
                      </p>
                    </div>
                ...
                >
                  <div className="p-6 text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-keystone-text-muted">
                        Use local AI models (requires Ollama)
                      </p>
                    </div>
              ...
              <div className="space-y-6">
                <div className="text-center">
                  <button
                    onClick={handleBackToModeTypeSelection}
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-keystone-accent mt-2">
